...
class ResettingController extends BaseController
{
     ...
     * @param int $retryTtl
     */
    public function __construct(EventDispatcherInterface $eventDispatcher, FactoryInterface $formFactory, UserManagerInterface $userManager, TokenGeneratorInterface $tokenGenerator, MailerInterface $mailer, $retryTtl = null)
    {
    ...
    public function resetAction(Request $request, $token)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success','Your password is reset successfuly !');
